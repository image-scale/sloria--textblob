...
- [x] Task 5: Implement WordList class with bulk word operations and case-insensitive counting (update blob.py + tests)
- [x] Task 6: Implement Sentence class with start/end indices and JSON serialization (update blob.py + tests)
- [x] Task 7: Implement Blobber factory class for creating TextBlobs with shared settings (update blob.py + tests)
- [x] Task 8: Implement noun phrase extraction using NLTK chunking (np_extractors.py, update blob.py + tests)
