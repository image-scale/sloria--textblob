"""Mixins for providing string-like and comparable behavior to blob classes."""

import sys


class ComparableMixin:
    """Implements rich comparison operators for an object."""
    ...
    def _compare(self, other, method):
        try:
            ...
            # _cmpkey not implemented, or returns different type,
...
class StringlikeMixin:
    ...
    Expects that classes that use this mixin have a _strkey() method that
    returns the string to apply string methods to.
    """
    ...
    def index(self, sub, start=0, end=sys.maxsize):
        """Like blob.find() but raises ValueError when the substring
        is not found.
        """
        return self._strkey().index(sub, start, end)

    def rindex(self, sub, start=0, end=sys.maxsize):
        """Like blob.rfind() but raises ValueError when substring is not
        found.
        """
